...
============================================================================
Config watcher for prism-bot. Monitors the config directory for file
...
log = logging.getLogger("prism-bot.config_watcher")
...
class ConfigWatcher:
    ...
    def __init__(
        ...
        # Snapshot initial mtimes so first-run files don't fire callbacks
    ...
    async def _poll_loop(self) -> None:
        ...
        while self._running:
            ...
            try:
                ...
                log.error(f"Config watcher poll error: {e}")
